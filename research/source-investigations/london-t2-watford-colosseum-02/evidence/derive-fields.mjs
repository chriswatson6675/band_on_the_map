...
// london-t2-watford-colosseum-02 (policy v1.2, "Offline derivation proof").
//
...
//   node research/source-investigations/london-t2-watford-colosseum-02/evidence/derive-fields.mjs
//
// Every value here is DIRECT_SOURCE: each event's own hero block states a
// complete day+month+year in one place ("Saturday 12th September 2026"),
// so no cross-context combination is required -- unlike the
...
/** Extract a complete day+month+year date from a retained hero_block's own <p class="date">/<p class="date variable-color"> text -- DIRECT_SOURCE only, never combined with anything else. */
...
const expected = {
  "fun-lovin-criminals": { title: "Fun Lovin' Criminals", start_date: "2026-09-12" },
  "10cc": { title: "10cc", start_date: "2027-03-11" },
  "francis-rossi": { title: "Francis Rossi", start_date: "2026-10-03" },
};

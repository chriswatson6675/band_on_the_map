...
// investigation.json (policy_version v1.2), printing any validation errors
// so they can be fixed before the investigation is considered complete.
...
if (errors.length === 0) {
  console.log("VALID: cco-sintra-01/investigation.json passes validateInvestigation() with zero errors.");
} else {

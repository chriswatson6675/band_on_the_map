...
// itself) — imports the real v1.1 validator from contract.mjs and runs it
...
if (errors.length === 0) {
  console.log("VALID: fama-dalfama-lisbon-01/investigation.json passes validateInvestigationV1_1 with zero errors.");
} else {
